...
const CategoriesPage = () => {
  return (
    <div className="relative z-10 w-[100%] h-[100vh]">
      ...
      <p className="font-poppins font-normal text-[200%] ml-[8%] mt-[5%]">
      ...
      <div className="flex flex-col justify-center items-center mt-14">
        ...
        <p className="font-poppins font-medium text-3xl py-5 ">
      ...
      <div className="relative mt-16">
        ...
        <div className="w-[42%] ml-[5%] absolute mt-[-15%]">
          <h1 className="font-publicsans font-semibold text-[210%] pb-4">
