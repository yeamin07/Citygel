...
const ProductCart = ({ item }) => {
  ...
  return (
    <div className="product-border container bg-white text-white box-border flex  max-w-full flex-col rounded-xl  border-[1px]  border-solid   border-gray-100 p-3 py-2.5 px-[10px] text-left font-poppins text-lg shadow-[0px_0px_10px_rgba(0,_0,_0,_0.15)]">
      <div>
        <ProductSlider
