    ...
    <div >
      <div>
        ...
        <div className="flex flex-col sm:items-start items-center">
          <Text
            as="p"
            className="sm:text-start z-[1] mt-[70px]  sm:text-[44px]  font-medium !text-black-900_03 text-center  !text-[28px] "
          >
            Preview & Pay
          </Text>
          <Text
            as="p"
            className="sm:text-left z-[1] mt-3 text-[14px]  !text-black-900_87 opacity-0.9  text-center sm:text-[16px] 2xl:w-[70%] xl:w-[90%] "
          >
        ...
        <div className="flex  xl:flex-row flex-col xl:items-start items-center  xl:space-x-10  pt-10 ">
          <div className="bg-white z-[6] box-border flex h-[568.8px] 2xl:w-[354.4px] w-80 max-w-full flex-col items-start justify-start gap-[8.69999999999709px] rounded-mid-5 border-[1.3px] border-solid border-gray-100 px-[7px] pt-[8.80000000000291px] pb-[8.69999999999709px] shadow-[0px_0px_8.75px_rgba(0,_0,_0,_0.15)]">
            ...
            <div className="box-border flex max-w-full flex-col items-start justify-start gap-[7.80000000000291px] self-stretch px-0 pt-0 pb-[14.10000000000582px]">
              <div className="text-white flex flex-row items-start justify-start gap-[8.5px] text-base-8 mq450:flex-wrap">
                <div className="flex flex-row items-start justify-start rounded-[8.75px] 2xl:px-[17.5px] px-2.5 pt-[5.30000000000291px] pb-[5.19999999999709px] [background:linear-gradient(90deg,_#fcb100,_#ed893e)]">
                ...
                <div className="flex flex-row items-start justify-start rounded-[8.75px] 2xlpx-[17.5px] px-2.5 pt-[5.30000000000291px] pb-[5.19999999999709px] [background:linear-gradient(90deg,_#fcb100,_#ed893e)]">
                  <div className="relative inline-block text-sm xl:text-base">
                    Premium
                  </div>
                </div>
              ...
              <div className="flex max-w-full  items-start justify-start self-stretch">
                ...
                <div className="text-gray-1100 xl:ml-[-113px] flex flex-col items-start justify-start px-0 pt-[4.400000000008731px] pb-0 text-mid-5">
          ...
          {!success ? (
            <>
              ...
              <form className="w-full  mt-10 xl:mt-0">
                <div className="box-border flex  xl:w-[686px] max-w-full flex-col items-start justify-start pt-[26px]  text-gray-600  w-full">
                  <div className="flex max-w-full flex-col items-start justify-start gap-[115px] self-stretch ">
                    <div className="box-border flex max-w-full flex-row items-start justify-start self-stretch py-0 pr-0 pl-[5px] mq750:pl-[0px] mq450:pl-[0px]">
                      <div className="flex max-w-full flex-1 flex-col items-start justify-start gap-[30px]">
                        <div className="box-border flex xl:w-[550px] w-full flex-col items-start justify-start gap-[6px] px-0 pt-0 pb-2.5">
                          <label
                            htmlFor="cardholderName"
                            className="relative inline-block xl:w-[393.9px]  uppercase text-black-900_03 mq450:text-base"
                          >
                            Card Holder Name
                          </label>
                          <input
                            ...
                            id="cardholderName"
                            className=" relative h-[46px]  self-stretch text-9xl-1 text-gray-500 w-full  "
                            defaultValue="Anne Jenny"
                          />
                        </div>
                        <div className="box-border flex xl:w-[681.4px] w-full flex-col items-start justify-start gap-[9.80000000000291px] px-0 pt-0 pb-[10.89999999999418px]">
                          <label
                            htmlFor="cardNumber"
                    ...
                    <div
                      ...
                      className="text-white z-[4] flex flex-row lg:items-start lg:justify-start justify-center items-center mx-auto lg:mx-0 whitespace-nowrap rounded-xl bg-gradient-to-r from-cyan-500 to-cyan-700 px-[76px] pt-[23px] pb-[22px] text-11xl shadow-md "
                    >
            ...
            <div className="flex w-full flex-col gap-8 ">
              ...
              <button
                onClick={() => navigate("/")}
                className="h-[60px] w-[150px] rounded-2xl bg-gradient-to-br from-cyan-600 to-cyan-400 text-[20px] text-white-A700 mx-auto lg:mx-0"
              >
                Go To Home
              </button>
