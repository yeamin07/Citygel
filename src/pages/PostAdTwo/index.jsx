    ...
    <>
      ...
      <div className="h-[3679px] w-full bg-gray-50 relative">
        <div className="flex flex-col items-start justify-start w-full top-0 right-0 left-0 m-auto absolute">
          ...
          <Img src="images/img_vector_19.png" alt="vectornineteen" className="w-[57%] mt-[-140px] object-cover" />
        </div>
        <div className="flex flex-col items-start justify-center w-full h-full left-0 bottom-0 right-0 top-0 m-auto absolute">
          <div className="h-[1485px] w-[56%] z-[1] relative">
            ...
            <div className="flex flex-col items-start justify-start w-[84%] gap-1.5 bottom-0 right-0 left-0 m-auto absolute">
              <div className="flex flex-col items-start justify-start ml-1.5">
                ...
                <Text as="p" className="mt-[106px] !text-black-900_99 opacity-0.7">
                  Brand
                </Text>
                <Text as="p" className="mt-[109px] !text-black-900_99 opacity-0.7">
                  Model
                </Text>
                <Text as="p" className="mt-[244px] !text-black-900_99 opacity-0.7">
                  Fuel Type
                </Text>
              </div>
              <div className="flex flex-col items-start justify-start w-full">
                <Input name="select" placeholder="-Select-" className="w-full" />
                <Text as="p" className="mt-[21px] ml-1.5 !text-black-900_99 opacity-0.7">
                  Listed By
                </Text>
                <Input name="selectone" placeholder="-Select-" className="w-full mt-[7px]" />
                <Text as="p" className="mt-[19px] ml-1.5 !text-black-900_99 opacity-0.7">
                  Transmision
                </Text>
                <Input name="selecttwo" placeholder="-Select-" className="w-full mt-[9px]" />
              </div>
            </div>
          </div>
          <div className="flex flex-col items-end justify-start w-full mt-[-441px]">
            <div className="flex flex-col items-center justify-center w-[21%] mr-[110px] px-14 py-[162px] z-[1] bg-gray-200_01">
              <Text size="10xl" as="p" className="mt-[923px] mb-[922px] !text-black-900_03">
                AD
              </Text>
            </div>
        ...
        <div className="flex flex-col items-start justify-start w-[95%] right-0 top-0 m-auto absolute">
          <div className="flex flex-row justify-start items-start">
            <Text size="8xl" as="p" className="mt-[364px] !text-black-900_03 z-[1]">
              Enter Details
            </Text>
            <Img src="images/img_vector_18.png" alt="vectoreighteen" className="w-[97%] ml-[-219px] object-cover" />
          </div>
          <Input name="selectthree" placeholder="-Select-" className="w-[49%] mt-[-16px]" />
        </div>
        <div className="flex flex-row justify-end items-start w-[95%] right-0 top-0 m-auto absolute">
          <Text size="3xl" as="p" className="w-[49%] mt-[452px] !text-black-900_87 z-[1] opacity-0.5 leading-[35px]">
            Lorem Ipsum is simply dummy text of the printing and typesetting Lorem Ipsum is simply dummy text of the
            printing and typesetting Lorem{" "}
          </Text>
          <div className="h-[1010px] w-[97%] ml-[-814px] relative">
            ...
            <div className="flex flex-col items-end justify-start w-[43%] bottom-[1%] right-[8%] m-auto absolute">
              ...
              <Img src="images/img_image_31.png" alt="imagethirtyone" className="w-full mt-[-215px] object-cover" />
            </div>
          </div>
        </div>
        <Input name="selectfour" placeholder="-Select-" className="w-[46%] left-[6%] top-[16%] m-auto absolute" />
        <Input name="selectfive" placeholder="-Select-" className="w-[46%] left-[6%] top-[20%] m-auto absolute" />
        <Input name="selectsix" placeholder="-Select-" className="w-[46%] left-[6%] top-[24%] m-auto absolute" />
        <div className="flex flex-col items-start justify-start w-[46%] gap-[9px] bottom-[34%] left-[6%] m-auto absolute">
          ...
          <div className="flex flex-col items-start justify-start w-full">
            <Input name="type_here" placeholder="Type here" className="w-full" />
            <Text as="p" className="mt-[19px] ml-1.5 !text-black-900_99 opacity-0.7">
              No of owners
            </Text>
            <Input name="selectseven" placeholder="-Select-" className="w-full mt-[9px]" />
            <Text as="p" className="mt-[19px] ml-1.5 !text-black-900_99 opacity-0.7">
              Ad Title
            </Text>
            <Input name="type_here_one" placeholder="Type here" className="w-full mt-[9px]" />
            <Text as="p" className="mt-[21px] ml-1.5 !text-black-900_99 opacity-0.7">
              Ad Description
            </Text>
            <TextArea name="type_here_two" placeholder="Type here" className="w-full mt-[7px] text-black-900_03" />
            <Text as="p" className="mt-[19px] ml-1.5 !text-black-900_99 opacity-0.7">
              Price
            </Text>
            <Input name="price" placeholder="Type here" className="w-full mt-[9px]" />
            <Text as="p" className="mt-[22px] ml-1.5 !text-black-900_99 opacity-0.7">
              Country
            </Text>
            <Input name="country" placeholder="-Select-" className="w-full mt-1.5" />
            <Text as="p" className="mt-[19px] ml-1.5 !text-black-900_99 opacity-0.7">
              State /Emirates
            </Text>
          </div>
        ...
        <div className="flex flex-col items-start justify-start w-[46%] bottom-[32%] left-[6%] m-auto absolute">
          ...
          <Input name="selecteight" placeholder="-Select-" className="w-full mt-[-22px]" />
        </div>
        <div className="flex flex-col items-center justify-start w-[46%] gap-[22px] bottom-[15%] left-[6%] m-auto absolute">
          <div className="flex flex-col items-start justify-start w-full">
            <Input name="selectnine" placeholder="-Select-" className="w-full" />
            <Text as="p" className="mt-[21px] ml-1.5 !text-black-900_99 opacity-0.7">
              Enquiry Type
            </Text>
            <div className="flex flex-col items-center justify-start mt-[7px] gap-2.5">
              <Input name="selectten" placeholder="-Select-" className="w-full" />
              <Input size="3xl" name="edittext" className="w-full" />
            </div>
          ...
          <div className="flex flex-col items-start justify-start w-full gap-1.5">
            ...
            <div className="h-[80px] w-full relative">
              <Input size="3xl" name="edittext_two" className="w-full left-0 bottom-0 right-0 top-0 m-auto absolute" />
              <Button
                color="blue_gray_100_03"
                size="3xl"
                variant="fill"
        ...
        <Text as="p" className="left-[6%] top-[26%] m-auto !text-black-900_99 opacity-0.7 absolute">
          Manufacturing Year
        </Text>
      </div>
    </>
