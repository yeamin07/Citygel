...
export default function LoginThreePage() {
  return (
    <>
      <Helmet>
        <title>Citygel</title>
          ...
          <div className="flex flex-col items-center justify-start w-full gap-[31px]">
            <div className="flex flex-col items-center justify-start w-full">
              <div className="flex flex-col items-center justify-start w-full gap-px max-w-[438px]">
                ...
                <Text size="4xl" as="p" className="!text-black-900_7e text-center opacity-0.4">
              ...
              <div className="flex flex-col items-start justify-start w-full mt-[9px]">
                ...
                <Text size="4xl" as="p" className="mt-2 !text-red-A700_7e text-center opacity-0.4">
                  Please enter your credential Details.
                </Text>
                <div className="flex flex-row justify-start w-full mt-[7px] gap-[18px]">
