...
const Fullheader = () => {
  return (
    <div className='overflow-hidden'>
        ...
        <h4 className='text-[48px] mq800:text-[22px] mq1500:text-[42px] mq1125:text-[37px] font-poppins pb-3'>Pricing & Plans</h4>
           <p className='text-[26px] mq800:text-[13px] mq1500:text-[22px] mq1125:text-[19px] font-poppins'>Lorem Ipsum is simply dummy text<br/> of the printing and typesetting Lorem Ipsum is<br/>
