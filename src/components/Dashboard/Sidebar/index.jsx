...
const Sidebar = ({ sidebarOpen, setSidebarOpen }) => {
  ...
  return (
    <aside
      ref={sidebar}
      className={`z-9999 w-72.5 bg-black absolute left-0 top-0 flex h-screen flex-col overflow-y-hidden bg-[#0B90AF] duration-300 ease-linear lg:static lg:translate-x-0 ${
    ...
    >
      ...
      <div className="no-scrollbar flex flex-col overflow-y-auto duration-300 ease-linear">
        ...
        <nav className="mt-5 py-4 px-4 lg:mt-9 lg:px-6">
          {/* <!-- Menu Group --> */}
          <div>
            <h3 className="mb-4 ml-4 text-sm font-semibold text-black-900_7e">
              Main Menu
            </h3>
...
<<<<<<< HEAD
              ...
              <li>
                ...
                <NavLink
                  ...
                  className={`group relative flex items-center gap-2.5 rounded-sm py-2 px-4 font-medium text-bodydark1 duration-300 ease-in-out hover:bg-graydark dark:hover:bg-meta-4 ${
                    pathname.includes("add-advertisement") &&
                    "bg-graydark dark:bg-meta-4"
                  }`}
                >
                  Advertisement
