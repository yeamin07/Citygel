...
const Header = (props) => {
  return (
    <header className="z-999 bg-white drop-shadow-1 dark:bg-boxdark sticky top-0 flex w-full dark:drop-shadow-none">
      <div className="shadow-2 flex flex-grow items-center justify-between px-4 py-4 md:px-6 2xl:px-11">
        <div className="flex items-center gap-2 sm:gap-4 lg:hidden">
          ...
          <button
            ...
            className="z-99999 border-stroke bg-white dark:border-strokedark dark:bg-boxdark block rounded-sm border p-1.5 shadow-sm lg:hidden"
          >
          ...
          <form action="https://formbold.com/s/unique_form_id" method="POST">
            <div className="relative">
              ...
              <input
                ...
                className="text-black dark:text-white xl:w-125 w-full bg-transparent pl-9 pr-4 focus:outline-none"
              />
            </div>
          </form>
        </div>
