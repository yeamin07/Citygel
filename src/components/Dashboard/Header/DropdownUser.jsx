    ...
    <div className="relative">
      ...
      >
        ...
        <span className="h-12 w-12 rounded-full">
          <img src={UserOne} alt="User" className="w-12" />
        </span>
      ...
      <div
        ...
        className={`w-56 border-stroke bg-white shadow-default dark:border-strokedark dark:bg-boxdark absolute right-0 mt-4 flex flex-col rounded-sm border ${
          dropdownOpen === true ? "block" : "hidden"
        }`}
      >
        <ul className="border-stroke py-7.5 bg-main-color  py-4 text-white-A700 dark:border-strokedark flex flex-col gap-5 border-b px-6">
          <li>
            <Link
              to="/dashboard/all-user"
              className="hover:text-white-A700 flex items-center gap-3.5 text-sm font-medium duration-300 ease-in-out lg:text-base"
            >
              <svg
        ...
        <button onClick={handleLogOut} className="hover:text-primary flex items-center gap-3.5 px-6 py-4 text-sm font-medium duration-300 ease-in-out lg:text-base">
          <svg
            className="fill-current"
            width="22"
            height="22"
