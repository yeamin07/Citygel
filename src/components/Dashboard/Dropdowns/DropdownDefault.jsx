...
const DropdownDefault = () => {
  ...
  return (
    <div className="relative flex">
      <button
        className="hover:text-body text-[#98A6AD]"
        ref={trigger}
      ...
      <div
        ...
        className={`border-stroke bg-white shadow-default dark:border-strokedark dark:bg-boxdark absolute right-0 top-full z-40 w-40 space-y-1 rounded-sm border p-1.5 ${
          dropdownOpen === true ? "block" : "hidden"
        }`}
      >
        <button className="hover:bg-gray dark:hover:bg-meta-4 flex w-full items-center gap-2 rounded-sm px-4 py-1.5 text-left text-sm">
          <svg
            className="fill-current"
            width="16"
            height="16"
