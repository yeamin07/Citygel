...
const PostAd = () => {
  return (
    <div className="w-[1920px] rounded-31xl bg-gray-200 overflow-hidden flex flex-col items-start justify-start relative gap-[83px] tracking-[normal] mq800:gap-[21px_83px] mq1125:gap-[41px_83px]">
      <FrameComponent1 />
      <main className="self-stretch flex flex-row items-start justify-center py-0 px-5 box-border max-w-full">
        <section className="w-[1700px] flex flex-col items-start justify-start gap-[9px] max-w-full text-left text-25xl text-black font-poppins">
