const OctalTree = () => {
  return (
    <div className="self-stretch flex flex-row items-start justify-center py-0 px-5 box-border max-w-full mt-[-271px] text-left text-base text-gray-1000 font-poppins">
      <div className="w-[1700px] rounded-11xl bg-white shadow-[0px_0px_5px_rgba(0,_0,_0,_0.1)] box-border flex flex-col items-start justify-start py-[30px] px-7 gap-[30px] max-w-full z-[3] border-[2px] border-solid border-gray-800 mq750:pt-[291px] mq750:pb-5 mq750:box-border">
        <div className="w-[1700px] h-[710px] relative rounded-11xl bg-white shadow-[0px_0px_5px_rgba(0,_0,_0,_0.1)] box-border hidden max-w-full border-[2px] border-solid border-gray-800" />
