  ...
  return (
    <div className="w-[1920px] h-[1781px] rounded-31xl bg-gray-200 overflow-hidden tracking-[normal] mq750:h-auto mq750:min-h-[1781]">
      ...
      <main className="absolute top-[366px] left-[0px] w-full flex flex-col items-start justify-start gap-[83px] max-w-full text-left text-25xl text-black font-poppins mq750:gap-[21px_83px] mq1050:gap-[41px_83px]">
        ...
        <section className="w-[1299px] flex flex-row items-start justify-center pt-0 px-5 pb-[8.300000000000182px] box-border max-w-full text-left text-22xl-5 text-main-color font-poppins">
          <div className="w-[1079px] flex flex-row items-end justify-start max-w-full">
            <div className="w-[1079px] rounded-[29.94px] bg-gray-900 [backdrop-filter:blur(40.3px)] flex flex-row items-start justify-start py-[46.09999999999991px] px-[78.29999999999927px] box-border gap-[39.10000000000037px] max-w-full z-[4] mq750:flex-wrap mq750:gap-[39.10000000000037px_20px] mq750:pl-[39px] mq750:pr-[39px] mq750:box-border">
              <div className="h-[537.8px] w-[1079px] relative rounded-[29.94px] bg-gray-900 [backdrop-filter:blur(40.3px)] hidden max-w-full" />
              <div className="w-[268px] flex flex-col items-start justify-start pt-0 px-0 pb-[0.8999999999996362px] box-border gap-[97px] min-w-[267.2000000000007px] z-[5] mq450:gap-[48px_97px] mq750:flex-1">
                <div className="self-stretch flex flex-col items-start justify-start pt-0 px-0 pb-0 gap-[23.030948638916016px]">
                  ...
                  <div className="self-stretch h-[101.3px] overflow-hidden shrink-0 flex flex-col items-start justify-start text-13xl-2">
                ...
                <div className="w-[238.4px] rounded-[27.64px] bg-steelblue-200 overflow-hidden flex flex-col items-start justify-center pt-[13px] pb-[12.800000000000182px] pr-[64.09999999999854px] pl-[63.30000000000109px] box-border mix-blend-normal whitespace-nowrap text-center text-mid-3 text-white">
              ...
              <div className="w-[267.2px] flex flex-col items-start justify-start gap-[61.90000000000009px] min-w-[267.2000000000007px] mq450:gap-[31px_61.90000000000009px] mq750:flex-1">
                <div className="self-stretch flex flex-col items-start justify-start gap-[23.049999999999955px]">
                  ...
                  <div className="self-stretch h-[101.3px] overflow-hidden shrink-0 flex flex-col items-start justify-start pt-0 px-0 pb-[53.30000000000018px] box-border gap-[7px] z-[5] text-13xl-2">
                    <div className="relative font-medium shrink-0 [debug_commit:612783b] mq450:text-lgi mq1050:text-7xl">
                      Professional
                    </div>
                    <div className="self-stretch relative text-mid-3 font-medium text-lightslategray shrink-0 [debug_commit:612783b]">
                ...
                <div className="rounded-[27.64px] bg-steelblue-200 overflow-hidden flex flex-row items-start justify-start pt-[13px] pb-[12.800000000000182px] pr-16 pl-[63.39999999999963px] mix-blend-normal whitespace-nowrap z-[5] text-center text-mid-3 text-white">
            ...
            <div className="w-[336.3px] flex flex-col items-start justify-start pt-0 px-0 pb-[23px] box-border max-w-full ml-[-388.1px] text-mid-3 text-white">
              <div className="self-stretch rounded-[29.94px] bg-main-color shadow-[0px_48.4px_39.15px_rgba(11,_144,_175,_0.3)] flex flex-col items-start justify-start py-[23px] pr-[34.49999999999818px] pl-[34.600000000000364px] gap-[23px] z-[5]">
                <div className="self-stretch flex flex-row items-start justify-end text-center text-[11.5px]">
                  <div className="rounded-[15.55px] bg-nd overflow-hidden flex flex-row items-start justify-start pt-[8.099999999999909px] pb-1.5 pr-5 pl-[18px] whitespace-nowrap">
                    <div className="w-[102px] relative tracking-[0.96px] leading-[18px] font-extrabold inline-block">
                      MOST POPULAR
                    </div>
                  </div>
                </div>
                ...
                <div className="self-stretch h-[101.3px] overflow-hidden shrink-0 flex flex-col items-start justify-start pt-0 px-0 pb-[53.30000000000018px] box-border gap-[7px] text-13xl-2">
                  <div className="relative font-medium shrink-0 [debug_commit:612783b] mq450:text-lgi mq1050:text-7xl">
                    Company
                  </div>
                  <div className="self-stretch relative text-mid-3 font-medium shrink-0 [debug_commit:612783b]">
                ...
                <div className="w-[238.4px] flex flex-col items-start justify-start pt-0 px-0 pb-[3.5px] box-border gap-[11.500000000000227px]">
                  <div className="self-stretch h-[24.2px] overflow-hidden shrink-0 flex flex-row items-start justify-start py-[0.599999999999909px] pr-px pl-0 box-border gap-[11px]">
                    ...
                    />
                    <div className="mt-[-1.5px] flex-1 relative font-medium">
                      Multi-step Zap
                    </div>
                  </div>
                  <div className="h-[24.2px] overflow-hidden shrink-0 flex flex-row items-start justify-start gap-[11.5px]">
                    ...
                    <div className="w-[203.8px] relative font-medium inline-block shrink-0">
                      Unlimited Premium Apps
                    </div>
                  </div>
                  <div className="self-stretch h-[24.2px] overflow-hidden shrink-0 flex flex-row items-start justify-start py-[0.599999999999909px] pr-px pl-0 box-border gap-[11px]">
                  ...
                  <div className="h-[24.2px] overflow-hidden shrink-0 flex flex-row items-start justify-start py-[0.599999999999909px] pr-px pl-0 box-border gap-[11px]">
                    <img
                      ...
                      src="/checkcircle1-7.svg"
                    />
                    <div className="mt-[-1.5px] relative font-medium">
                      Custom Data Retention
                    </div>
                  </div>
                </div>
                <div className="rounded-[27.64px] bg-white overflow-hidden flex flex-row items-start justify-start pt-[12.300000000000182px] px-[78.10000000000036px] pb-[12.399999999999636px] whitespace-nowrap text-center text-nd mq450:pl-5 mq450:pr-5 mq450:box-border">
                  <div className="w-[111px] relative font-medium inline-block">
                    Choose plan
                  </div>
                </div>
        ...
        <div className="w-[1259px] flex flex-row items-start justify-center py-0 px-5 box-border max-w-full text-11xl text-white">
          <div className="w-[1039px] flex flex-row items-end justify-between gap-[20px] max-w-full mq1050:flex-wrap mq1050:justify-center">
            <div className="rounded-xl bg-lightgray shadow-[0px_0px_3px_rgba(0,_0,_0,_0.1)] flex flex-row items-start justify-start pt-[23px] px-[77px] pb-[22px] z-[2] mq450:pl-5 mq450:pr-5 mq450:box-border">
              ...
              <div className="relative z-[3] mq450:text-lg mq1050:text-5xl">
                Previous
              </div>
            </div>
      ...
      <div className="absolute top-[0px] left-[0px] w-[1920px] h-[1485.2px]">
        <img
        ...
        <img
          className="absolute top-[237px] left-[1103px] w-[744px] h-[774px] object-contain z-[6]"
          loading="lazy"
          alt=""
          src="/image-31@2x.png"
        />
