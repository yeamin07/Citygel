...
const PostAd1 = () => {
  return (
    <div className="w-screen h-auto">
      <Fullheader>
        <div className="w-screen h-[900px] rounded-31xl overflow-hide tracking-[normal] mq750:h-auto mq750:min-h-[1781]">
          <main className="absolute top-[30px] left-[0px] w-full flex flex-col items-start justify-start gap-[83px] max-w-full text-left text-25xl text-black font-poppins mq750:gap-[21px_83px] mq1050:gap-[41px_83px]">
            ...
            <section className="w-[1299px] flex flex-row items-start justify-center pt-0 px-5 pb-[8.300000000000182px] box-border max-w-full text-left text-22xl-5 text-main-color font-poppins">
              <div className="w-[1079px] flex flex-row items-end justify-start max-w-full">
                <div className="w-[1079px] rounded-[29.94px] bg-whitesmoke-100 [backdrop-filter:blur(40.3px)] flex flex-row items-start justify-start py-[46.09999999999991px] px-[78.29999999999927px] box-border gap-[39.10000000000037px] max-w-full z-[4] mq750:flex-wrap mq750:gap-[39.10000000000037px_20px] mq750:pl-[39px] mq750:pr-[39px] mq750:box-border">
                  ...
                  <div className="w-[268px] flex flex-col items-start justify-start pt-0 px-0 pb-[0.8999999999996362px] box-border gap-[97px] min-w-[267.2000000000007px] z-[5] mq450:gap-[48px_97px] mq750:flex-1">
                    ...
                    <div className="cursor-pointer w-[238.4px] rounded-[27.64px] bg-steelblue-200 overflow-hidden flex flex-col items-start justify-center pt-[13px] pb-[12.800000000000182px] pr-[64.09999999999854px] pl-[63.30000000000109px] box-border mix-blend-normal whitespace-nowrap text-center text-mid-3 text-white">
                  ...
                  <div className="w-[267.2px] flex flex-col items-start justify-start gap-[61.90000000000009px] min-w-[267.2000000000007px] mq450:gap-[31px_61.90000000000009px] mq750:flex-1">
                    ...
                    <div className="cursor-pointer rounded-[27.64px] bg-steelblue-200 overflow-hidden flex flex-row items-start justify-start pt-[13px] pb-[12.800000000000182px] pr-16 pl-[63.39999999999963px] mix-blend-normal whitespace-nowrap z-[5] text-center text-mid-3 text-white">
                ...
                <div className="w-[336.3px] flex flex-col items-start justify-start pt-0 px-0 pb-[23px] box-border max-w-full ml-[-388.1px] text-mid-3 text-white">
                  <div className="self-stretch rounded-[29.94px] bg-main-color shadow-[0px_48.4px_39.15px_rgba(11,_144,_175,_0.3)] flex flex-col items-start justify-start py-[23px] pr-[34.49999999999818px] pl-[34.600000000000364px] gap-[23px] z-[5]">
                    ...
                    <div className=" cursor-pointer rounded-[27.64px] bg-white overflow-hidden flex flex-row items-start justify-start pt-[12.300000000000182px] px-[78.10000000000036px] pb-[12.399999999999636px] whitespace-nowrap text-center text-nd mq450:pl-5 mq450:pr-5 mq450:box-border">
                      <div className=" text-white-A700 w-[111px] relative font-medium inline-block">
                        Choose plan
                      </div>
                    </div>
                  </div>
